...
function AddCamera({onClose}) {
    ...
    return(
        <div className="fixed inset-0 flex justify-center items-center bg-black/50 z-100">
            <div className="bg-white flex flex-col justify-center items-center rounded-xl p-6 min-w-[500px] max-w-[90%] shadow-3xl gap-4">
                ...
                <form onSubmit={handleSubmit} className="w-full">
                    <div className="flex flex-col items-center gap-3 w-full">
                        ...
                        <button
                            className="confirm-button px-3 py-2"
                            type="submit"
                            disabled={loading}>{loading ? "Creating new camera ..." : "Create camera"}</button>
                    </div>
                </form>
                <button
                    className="close-button px-3 py-2"
                    onClick={onClose}
                >
                    Close
                </button>
